...
| En tant que **service client**, j'ai besoin d'**une liste des visiteurs ayant posé une question** afin de **pouvoir repondre à leurs questions** | GET\|POST | `/service` | `ServiceClientController` | `index` |
| En tant que **service client**, j'ai besoin d'**ajouter une réservation** afin de **pouvoir modifier une reservation** | GET\|POST | `/service/add` | `ServiceClientController` | `contact` |
| En tant que **service client**, j'ai besoin du**numero de réservation** afin de **pouvoir modifier une reservation** | GET\|POST | `/service/update` | `ServiceClientController` | `contact` |
